...
TARGET_SPECIFIC_HEADER_PATH := device/oppo/x909/include
...
TARGET_BOOTLOADER_BOARD_NAME := x909
TARGET_BOOTLOADER_NAME=x909
TARGET_BOARD_INFO_FILE := device/oppo/x909/board-info.txt

BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/oppo/x909/bluetooth
...
BOARD_EGL_CFG := device/oppo/x909/configs/egl.cfg
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/oppo/x909/recovery/recovery_keys.c
...
TARGET_RELEASETOOLS_EXTENSIONS := device/oppo/x909
...
-include vendor/oppo/x909/BoardConfigVendor.mk
